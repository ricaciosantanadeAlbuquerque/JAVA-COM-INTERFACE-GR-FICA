...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Não está logado");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      if(usuario.equals(this.usuario) && senha.equals(this.senha)){
          ...
          jLabel5.setText("algum erro");
      }
      
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if(this.novousuario == null){ // se é igual a null e porque não tem objeto
            novousuario = new NovoUsuario(); // cria objeto
            novousuario.setLocationRelativeTo(null);
            novousuario.setResizable(true);
        ...
        novousuario.indoParaNovousuario(this);
