...
public class Jogo extends javax.swing.JFrame {
    /*é necessário que as variáveis sejam globais,
    para poderem ser  enchergadas em qualquer parte do código*/
    private String senha1;
    private String senha2;
    private String senha3;
   private SistemaLogin partida;
   ...
   public void gerarSenha(){
       ...
       ale3 = "";
       for(int i = 0; i < 3;i++){
           ale1 = String.valueOf(aleatorio.nextInt(3)+1);
           ale2 = String.valueOf(aleatorio.nextInt(3)+1);
           ale3 = String.valueOf(aleatorio.nextInt(3)+1);
           if( i == 0){ // primeiro loop
               ...
               this.senha3 = ale1+ale2+ale3+""; // concatenação
           }
       }
    ...
    public Jogo() {
        initComponents();
        this.gerarSenha();// chamada ao método gerar
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tente Adivinhar a senha contendo até três valores");

        jLabel9.setText("Faça sua jogada");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       if(senha.equals("")){
           ...
           if(senha.equals(this.senha1) ){
           jLabel5.setText("Aberto!");
           jLabel9.setText("Parabéns você acertou !");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      ...
      if(senha.equals("")){
          ...
          if(senha.equals(this.senha3)){
              jLabel7.setText("Aberto! ");
              jLabel9.setText("Parabéns você acertou ! ");
    ...
    void indoParaJogo(SistemaLogin objeto1) {
        this.partida = objeto1;
    }
}
